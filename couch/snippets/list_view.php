...
<!-- --------------------------------------------------------------------------- -->
    ...
    <cms:pages masterpage='index.php' >
        <div id="grid_content">
            ...
            <div class="overlay"><span><cms:show k_page_title /></span></div>
        </div>
    </cms:pages>
	  ...
	  <div id="oncanvas-menu">
        <label for="togglebox" style="width: 100%;">
            <div id="toggle" onclick="myFunction(this)">
                ...
                <div style="color:#3737ff; font-size:12.5px; line-height:30px; text-align:center; letter-spacing:1.5px;" class="UniSansSemiBold">INFO</div>
            </div>
        </label>
